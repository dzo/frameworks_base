...
public abstract class PhoneBase extends Handler implements Phone {
    ...
    protected PhoneBase(PhoneNotifier notifier, Context context, CommandsInterface ci,
        ...
        */
         ...
         *
         * By default old phones won't have the property set and may or may
         * not generate the RIL_UNSOL_CALL_RING, so the default if there is
         * no property is false. That means generate locally if the property
         * is not available.
         */
        mDoesRilSendMultipleCallRing = SystemProperties.getBoolean(
                TelephonyProperties.PROPERTY_RIL_SENDS_MULTIPLE_CALL_RING, false);
    ...
    private void setPropertiesByCarrier() {
        ...
        for (int i = 0; i < carrierLocales.length; i+=3) {
            ...
            if (carrier.equals(c)) {
                ...
                MccTable.setSystemLocale(mContext, language, country, false);
